 ...
 */
public class TaxiDriverPassengerMessengerData implements MessengerData {

	public final long currentPassengerPosition;
	public final long passengerWantedDestination;
	public final int bidingPrice;
	
	public TaxiDriverPassengerMessengerData(long currentPassengerPosition, long passengerWantedDestination, int bidingPrice) {	
